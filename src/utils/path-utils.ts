 ...
 */
export function toRelativePath(configFilePath: string, absolutePath: string): string {
 ...
 */
export function toAbsolutePath(configFilePath: string, relativePath: string): string {
  const configDir = path.dirname(configFilePath);
